...
public class TopCoderAction extends AnAction {
	...
	public void actionPerformed(AnActionEvent e) {
		...
		//use default javaws
		String javaExecutable = "javaws"; //System.getProperty("java.home") + File.separator + "bin" + File.separator + "javaws";
		try {
	...
	private static void createConfiguration(Project project, TopCoderTask task) {
		...
		VirtualFile javaFile = FileUtilities.getFile(project, defaultDir + "/" + task.name + ".java");
		if (javaFile == null) {
			javaFile = FileUtilities.writeTextFile(FileUtilities.getFile(project, defaultDir),
		...
		ApplicationManager.getApplication().invokeLater(() -> {
			final PsiElement main = Utilities.getPsiElement(project, fqn);
